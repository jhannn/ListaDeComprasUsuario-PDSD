...
function pesquisarProduto()
{
	...
	if(nome != "" && embalagem != 0){
		...
		url = "http://192.168.1.95/Servidor/Produto.asmx/pesquisarProdutosEmbalagem"
		passou=true;
	}
	...
	//------ Pesquisar por nome -----//
		...
		url   = "http://192.168.1.95/Servidor/Produto.asmx/pesquisarProdutosNome";
		passou=true;
	}
	...
	//------ Pesquisar por marca -----//
		...
		url = "http://192.168.1.95/Servidor/Produto.asmx/pesquisarProdutosMarca"	
		passou=true;
	}
...
function adicionarProdutoNaLista(){	
	...
	$.ajax({
        type: 'POST'
        , url: "http://192.168.1.95/Servidor/ListaDeProdutos.asmx/cadastrarProduto"
		, crossDomain:true
        , contentType: 'application/json; charset=utf-8'
        , dataType: 'json'
